...
export const ABLLS_AGE_REFERENCE: AbllsAgeRef[] = [
  ...
  { code: "Q", expectedFromMonths: 72, academic: true, note: "Cititul — abilitate academică de pregătire școlară; de regulă nu e încă așteptată sub ~6 ani." },
  { code: "R", expectedFromMonths: 72, academic: true, note: "Matematica — abilitate academică; de obicei vizată în jurul vârstei școlare (~6 ani)." },
  { code: "S", expectedFromMonths: 72, academic: true, note: "Scrisul — abilitate academică/grafomotorie; nu e încă așteptată sub ~6 ani." },
  { code: "T", expectedFromMonths: 78, academic: true, note: "Spelling/ortografie (ROMÂNĂ) — abilitate academică avansată, după debutul cititului și scrisului." },
