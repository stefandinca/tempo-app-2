...
export default function LatestSessionSummary({ session, onClick }: LatestSessionSummaryProps) {
  ...
  const therapist = (team || []).find(t => t.id === session.therapistId);
  ...
  // Calculate success rate for the session if scores exist
  ...
  return (
    <section className="px-4">
      ...
      >
        {/* Top Header with Date and Attendance */}
